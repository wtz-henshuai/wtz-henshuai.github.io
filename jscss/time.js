function showTime() { 
	...
	var startDate = new Date(2020, 12, 24, 20, 15, 0);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear 李海燕:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----王太重   2019-12-08</c>"; 
